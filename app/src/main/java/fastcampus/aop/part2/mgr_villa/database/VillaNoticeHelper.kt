...
@Database(entities = arrayOf(VillaUsers::class, VillaInfo::class, VillaNotice::class, StandardCost::class
    , VillaTenant::class, VillaAccount::class, VillaTenantCost::class), version = 1, exportSchema = false)
