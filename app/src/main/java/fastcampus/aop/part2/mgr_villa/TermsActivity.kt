...
import fastcampus.aop.part2.mgr_villa.databinding.ActivityTermsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.TermsText.setText(
            "우리빌(WRV) 서비스 및 콘텐츠 이용약관\n" +
                    ...
                    "       제1장 총칙\n" +
                    "\n" +
                    " 제1조(목적) 이 약관은 회사가 온라인으로 제공하는 제반서비스의 이용과 관련하여 회사와 이용자와의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다. \n" +
...
//    }
    ...
    private fun initToolBar() {
        val toolbar = findViewById<Toolbar>(R.id.TermsToolbar)
